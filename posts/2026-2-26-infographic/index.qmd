...
Horse race data was sourced from [netkeiba](https://www.netkeiba.com/), a website that hosts official Japan Racing Association (JRA) data. This was done by a user on Kaggle, an online data science community where users can find datasets to work with or publish their own. The user who published this horse racing data used web-scraping tools to assimilate the race results data used in the analysis. 
