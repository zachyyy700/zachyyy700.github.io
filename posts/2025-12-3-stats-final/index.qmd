...
#| fig-cap: "Histograms for all water quality parameters in dataset."
...
```{r}
#| label: fig-sim-data
#| fig-cap: "Scatterplot of simulated response and predictor."
...
```{r}
#| label: fig-sim-model
#| fig-cap: "Simulated data with Gamma model fit."
...
```{r}
#| label: fig-real-data
#| fig-cap: "Scatterplot of real data."
# Raw scatterplot
...
#| fig-cap: "Real data with Gamma model fit."
...
#| tbl-cap: "Secchi.m coefficient estimates & p-values for all water quality parameters in dataset."
response_df |> 
  filter(term == "secchi.m") |> 
  select(-term) |> 
  kbl(col.names = c("Response", "Estimate", "p-value"), digits = 3, align = 'c')
```
